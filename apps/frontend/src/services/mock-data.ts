...
export const mockAssets: Asset[] = [
  ...
  { id: "a4", name: "Plant", category: "decoration", icon: "🌿", color: "#22C55E", width: 1, height: 1, collision: "none" },
  ...
  { id: "a10", name: "Speaker", category: "interactive", icon: "🔊", color: "#3B82F6", width: 1, height: 1, collision: "none" },
  { id: "a11", name: "Firepit", category: "interactive", icon: "🔥", color: "#EF4444", width: 2, height: 2 },
  { id: "a12", name: "Zen Garden", category: "decoration", icon: "🪨", color: "#A8A29E", width: 3, height: 3, collision: "none" },
  ...
  { id: "a18", name: "Water Cooler", category: "interactive", icon: "💧", color: "#38BDF8", width: 1, height: 1, collision: "none" },
  ...
  { id: "a24", name: "Tree", category: "decoration", icon: "🌳", color: "#064E3B", width: 2, height: 2, collision: "partial" },
  { id: "a25", name: "Purple Plant", category: "decoration", icon: "🪴", color: "#8B5CF6", width: 1, height: 1, collision: "none" },
  ...
  { id: "a30", name: "Oak Tree", category: "decoration", icon: "🌳", color: "#064E3B", width: 2, height: 2, collision: "partial" },
  { id: "a31", name: "Pine Tree", category: "decoration", icon: "🌲", color: "#064E3B", width: 2, height: 2, collision: "partial" },
  { id: "a32", name: "Cherry Blossom", category: "decoration", icon: "🌸", color: "#F472B6", width: 2, height: 2, collision: "partial" },
  { id: "a33", name: "Palm Tree", category: "decoration", icon: "🌴", color: "#10B981", width: 2, height: 2, collision: "partial" },
